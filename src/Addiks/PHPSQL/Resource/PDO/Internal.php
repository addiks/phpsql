...
namespace Addiks\Database\Resource\PDO;

use Addiks\Database\Resource\Statement;

use Addiks\Database\Value\Database\Dsn\Internal as InternalDSN;
...
class Internal extends \PDO{
	...
	/**
	 * @return \Addiks\Database\Resource\Database
	 */
	protected function getDatabaseResource(){
		if(is_null($this->databaseResource)){
			...
			$this->setDatabaseResource($databaseResource);
		}
		return $this->databaseResource;
	}
	
	protected function setDatabaseResource(Database $databaseResource){
	...
	public function __construct ($dsn, $username, $passwd, $options) {
		...
		$dsnValue = InternalDSN::factory("internal:default");
	...
	public function prepare ($statement, $driver_options = null) {
		...
		/* @var $statementResource Statement */
		$this->factorize($statementResource, [$statement]);
	...
	public function exec ($statement) {
		...
		/* @var $statement \Addiks\Database\Resource\Statement */
		$this->factorize($statement, [$statement]);
