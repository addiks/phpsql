...
use Addiks\Database\Entity\Job\Statement\Create\CreateDatabaseStatement;
use Addiks\Database\Entity\Job\Statement\Create\CreateIndexStatement;
use Addiks\Database\Entity\Job\Statement\Create\CreateTableStatement;
use Addiks\Database\Service\SqlParser\Part\ValueParser;
use Addiks\Database\Value\Enum\Sql\IndexType;
use Addiks\Database\Entity\Job\Part\Index as IndexPart;
use Addiks\Database\Entity\Job\Statement\Create\Index;
use Addiks\Database\Service\SqlParser\Part\Condition;
use Addiks\Database\Service\SqlParser\Part\Specifier\ColumnParser;
use Addiks\Database\Service\SqlParser\Part\ColumnDefinition;
use Addiks\Database\Service\SqlParser\Part\Specifier\TableParser;
use Addiks\Database\Service\SqlParser\Select;
...
class CreateSqlParser extends SqlParser{
	...
	/**
	 * @return Create
	 * @see Addiks\Database.SqlParser::convertSqlToJob()
	 */
	...
	protected function parseCreateTable(SQLTokenIterator $tokens){
		...
		$this->factorize($columnDefinitonParser);
		...
		/* @var $createTableJob CreateTableStatement */
		$this->factorize($createTableJob);
	...
	protected function parseCreateIndex(SQLTokenIterator $tokens){
		...
		do{
			...
			}else if($tokens->seekTokenNum(SqlToken::T_DESC())){
