...
use Addiks\Database\Entity\Job\Part\Condition\Enum;

use Addiks\Database\Entity\Job\Part\Condition\Like;

use Addiks\Database\Entity\Job\Part\Parenthesis;

use Addiks\Database\Value\Sql\Variable;
...
use Addiks\Database\Entity\Job\Part\FlowControl\CaseData;
...
class ValueResolver extends Service{
	...
	public function resolveFunction(FunctionJob $functionJob){
		...
		$className = "\Addiks\Database\{$classNameFunctionPart}";
